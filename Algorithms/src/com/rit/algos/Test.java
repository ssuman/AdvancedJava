...
public class Test {
	...
	public Test init(TreeSet<String> bTreeSet) {
		this.aTreeSet = bTreeSet;
		return this;
	}

	public void end(String whatKind) {
		System.err.println(whatKind + ": Time for all:	"
	...
	public void iteratorTest() {
		...
		int runner = 0;
		while (aIterator.hasNext()) {
			allObjectsToRemove[runner++] = aIterator.next(); // remove can not
																// be done ...
		}
